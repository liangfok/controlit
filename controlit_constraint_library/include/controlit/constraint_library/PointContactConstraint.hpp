...
#ifndef __CONTROLIT_CONSTRAINT_LIBRARY_POINT_CONSTRAINT_HPP__
#define __CONTROLIT_CONSTRAINT_LIBRARY_POINT_CONSTRAINT_HPP__
...
class PointContactConstraint : public controlit::Constraint
{
public:
...
protected:
    ...
    /*!
     * The contact point in the joint's local frame.
     */
    Vector cp1_;
