...
#     target_link_libraries(${target} ${CONTROLIT_LIBS})
...
#     list(APPEND CONTROLIT_LIBS ${YAMLCPP_LIBRARY})
...
#     list(APPEND CONTROLIT_LIBS ${RBDL_LIBRARY})
...
#     list(APPEND CONTROLIT_LIBS jsoncpp)
...
#     list(APPEND CONTROLIT_LIBS ${MUPARSER_LIBRARY})
...
#     list(APPEND CONTROLIT_LIBS ${ZMQ_LIBRARIES})
