...
#ifndef __CONTROLIT_ROBOT_INTERFACE_LIBRARY_ROBOT_INTERFACE_BENCHMARK_HPP__
#define __CONTROLIT_ROBOT_INTERFACE_LIBRARY_ROBOT_INTERFACE_BENCHMARK_HPP__
 ...
 */
class RobotInterfaceBenchmark : public controlit::RobotInterface
{
public:
    /*!
     * The constructor.
     */
    RobotInterfaceBenchmark();

    /*!
     * The destructor.
     */
    virtual ~RobotInterfaceBenchmark();
...
private:
     ...
     */
    // std::unique_ptr<controlit::addons::ros::RealtimePublisher<controlit_robot_interface_library::JointState>>
    //     commandPublisher;
    ...
    /*!
     * The most recently-received RTT sequence number.
     */
    // uint8_t rcvdRttSeqNo;

    /*!
     * The time when rttSeqNo was last incremented.
     */
    // high_resolution_clock::time_point lastRTTUpdate;

    /*!
     * Real-time safe publisher for RTT latency messages
     */
    // std::unique_ptr<controlit::addons::ros::RealtimePublisher<std_msgs::Float64>>
        // rttLatencyPublisher;
};
...
#endif // __CONTROLIT_ROBOT_INTERFACE_LIBRARY_ROBOT_INTERFACE_BENCHMARK_HPP__
