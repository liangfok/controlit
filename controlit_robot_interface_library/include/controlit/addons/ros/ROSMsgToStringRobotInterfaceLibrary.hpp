...
#ifndef __CONTROLIT_ROBOT_INTERFACE_CONTROLIT_ADDONS_ROS_MSG_TO_STRING_HPP__
#define __CONTROLIT_ROBOT_INTERFACE_CONTROLIT_ADDONS_ROS_MSG_TO_STRING_HPP__
 ...
 */
inline std::string jointStateMsgToString(const controlit_robot_interface_library::JointState & msg,
  const std::string prefix = "")
{
  ...
  buff << prefix << "rtt_seq_no: " << msg.rtt_seq_no << "\n";
